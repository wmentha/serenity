...
public:
    virtual void paint_button(Painter&, IntRect const&, Palette const&, ButtonStyle, bool pressed, bool hovered = false, CheckState check_state = CheckState::Unchecked, bool enabled = true, bool focused = false, bool default_button = false) override;
    ...
    virtual void paint_radio_button(Painter&, IntRect const&, Palette const&, CheckState check_state, bool is_being_pressed) override;
    virtual void paint_check_box(Painter&, IntRect const&, Palette const&, bool is_enabled, CheckState check_state, bool is_being_pressed) override;
